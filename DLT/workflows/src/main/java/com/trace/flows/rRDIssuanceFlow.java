...
@InitiatingFlow
@StartableByRPC
public class rRDIssuanceFlow extends FlowLogic<SignedTransaction> {

    private final Amount<Currency> amount;
    private final String retailOwner;

    private final ProgressTracker.Step GENERATING_TRANSACTION = new ProgressTracker.Step("Generating transaction based on new rRD issuance.");
    ...
    public rRDIssuanceFlow(Amount<Currency> amount, String retailOwner) {
        this.amount = amount;
    ...
    public SignedTransaction call() throws FlowException {
        ...
        if (peritelStates.isEmpty() || retailStates.isEmpty()) {
        ...
        rRDAccountState retailOutputState = new rRDAccountState(
                ...
                retailInputState.getState().getData().getTokenBalance().plus(amount),
        ...
        final TransactionBuilder txBuilder = new TransactionBuilder(notary)
                ...
                .addCommand(new rRDContract.Commands.rRDIssuanceCommand(), getOurIdentity().getOwningKey());

        if (observer != null) {
            txBuilder.addCommand(new rRDContract.Commands.rRDIssuanceCommand(), observer.getOwningKey());
        }
